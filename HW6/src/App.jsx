...
function App() {
  ...
  return (
    <>
      ...
      <CesiumContainer imageProvider={imageProvider} terrainProvider={terrainProvider} waterMask={option.waterMask} lighting={option.lighting} selectedCity={city} pointStyle={pointStyle}/>
    </>
  )
}
